...
## 1. Role and Workflow
* **Role**: Primary Developer (Vibecoder).
* **Workflow**: In this specific repository, the user does not code manually. The AI agent is responsible for writing all code, executing commands, and implementing features end-to-end (Vibecoding).
